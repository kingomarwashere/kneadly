...
const DICT = {
  en: {
    ...
    free4_t: 'Everything included', free4_d: 'Deposits, loyalty rewards, multi-therapist rosters, 6-language booking, Google Maps — all free, nothing gated.',
    ...
    vs_r8: 'Multi-language booking page', vs_r8a: '6 languages', vs_r8b: 'Limited',
  ...
  th: {
    ...
    free4_t: 'รวมทุกอย่าง', free4_d: 'มัดจำ รางวัลสะสมแต้ม ตารางหมอนวดหลายคน หน้าจอง 6 ภาษา Google Maps — ฟรีทั้งหมด ไม่มีล็อกไว้',
    ...
    vs_r8: 'หน้าจองหลายภาษา', vs_r8a: '6 ภาษา', vs_r8b: 'จำกัด',
  ...
  zh: {
    ...
    free4_t: '一切都包含在内', free4_d: '定金、忠诚奖励、多理疗师排班、6 种语言预约页面、Google 地图 — 全部免费，毫无保留。',
    ...
    vs_r8: '多语言预约页面', vs_r8a: '6 种语言', vs_r8b: '有限',
  ...
  vi: {
    ...
    free4_t: 'Bao gồm mọi thứ', free4_d: 'Tiền cọc, phần thưởng thân thiết, lịch làm nhiều kỹ thuật viên, trang đặt lịch 6 ngôn ngữ, Google Maps — tất cả miễn phí, không giới hạn.',
    ...
    vs_r8: 'Trang đặt lịch đa ngôn ngữ', vs_r8a: '6 ngôn ngữ', vs_r8b: 'Hạn chế',
  ...
  ko: {
    ...
    free4_t: '모든 것이 포함', free4_d: '예약금, 로열티 리워드, 다중 관리사 스케줄, 6개 언어 예약 페이지, Google 지도 — 모두 무료, 제한 없음.',
    ...
    vs_r8: '다국어 예약 페이지', vs_r8a: '6개 언어', vs_r8b: '제한적',
  ...
  ja: {
    ...
    free4_t: 'すべて込み', free4_d: '手付金、ロイヤルティ特典、複数セラピストのシフト、6言語の予約ページ、Googleマップ — すべて無料、制限なし。',
    ...
    vs_r8: '多言語の予約ページ', vs_r8a: '6言語', vs_r8b: '限定的',
