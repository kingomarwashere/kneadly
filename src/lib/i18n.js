...
const DICT = {
  en: {
    ...
    group_q: 'Booking for more than one? (couple / group)', guest: 'Guest', group_booked: 'Group booking · {n} people', group_total: 'Total ({n} people)',
  ...
  th: {
    ...
    group_q: 'จองสำหรับมากกว่าหนึ่งคน? (คู่รัก / กลุ่ม)', guest: 'ผู้เข้าใช้บริการ', group_booked: 'การจองแบบกลุ่ม · {n} คน', group_total: 'รวม ({n} คน)',
  ...
  zh: {
    ...
    group_q: '预约多人？（情侣 / 团体）', guest: '客人', group_booked: '团体预约 · {n} 人', group_total: '合计（{n} 人）',
  ...
  vi: {
    ...
    group_q: 'Đặt cho nhiều người? (cặp đôi / nhóm)', guest: 'Khách', group_booked: 'Đặt lịch nhóm · {n} người', group_total: 'Tổng ({n} người)',
  ...
  ko: {
    ...
    group_q: '여러 명 예약? (커플 / 단체)', guest: '고객', group_booked: '단체 예약 · {n}명', group_total: '합계 ({n}명)',
  ...
  ja: {
    ...
    group_q: '複数人で予約？（カップル / グループ）', guest: 'ゲスト', group_booked: 'グループ予約 · {n}名', group_total: '合計（{n}名）',
