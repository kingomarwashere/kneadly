...
const DICT = {
  en: {
    ...
    group_q: 'Booking for more than one? (couple / group)', bk_type: 'Who is this booking for?', just_me: 'Just me', group_couple: 'Group / couple', add_person: 'Add another person', remove_word: 'Remove', same_time_note: 'Everyone is booked at the same date & time you pick above. Each person can choose their own service & therapist.', guest: 'Guest', group_booked: 'Group booking · {n} people', group_total: 'Total ({n} people)',
  ...
  th: {
    ...
    group_q: 'จองสำหรับมากกว่าหนึ่งคน? (คู่รัก / กลุ่ม)', bk_type: 'การจองนี้สำหรับใคร?', just_me: 'เฉพาะฉัน', group_couple: 'กลุ่ม / คู่รัก', add_person: 'เพิ่มอีกคน', remove_word: 'ลบ', same_time_note: 'ทุกคนจะถูกจองในวันและเวลาเดียวกับที่คุณเลือกด้านบน แต่ละคนเลือกบริการและหมอนวดของตนเองได้', guest: 'ผู้เข้าใช้บริการ', group_booked: 'การจองแบบกลุ่ม · {n} คน', group_total: 'รวม ({n} คน)',
  ...
  zh: {
    ...
    group_q: '预约多人？（情侣 / 团体）', bk_type: '这次预约是为谁？', just_me: '只有我', group_couple: '团体 / 情侣', add_person: '再加一人', remove_word: '删除', same_time_note: '所有人都预约在您上面选择的同一日期和时间。每人可选择各自的服务和理疗师。', guest: '客人', group_booked: '团体预约 · {n} 人', group_total: '合计（{n} 人）',
  ...
  ko: {
    ...
    group_q: '여러 명 예약? (커플 / 단체)', bk_type: '누구를 위한 예약인가요?', just_me: '혼자', group_couple: '단체 / 커플', add_person: '다른 사람 추가', remove_word: '삭제', same_time_note: '모든 사람은 위에서 선택한 동일한 날짜와 시간에 예약됩니다. 각자 서비스와 관리사를 선택할 수 있습니다.', guest: '고객', group_booked: '단체 예약 · {n}명', group_total: '합계 ({n}명)',
  ...
  ja: {
    ...
    group_q: '複数人で予約？（カップル / グループ）', bk_type: '誰の予約ですか？', just_me: '自分だけ', group_couple: 'グループ / カップル', add_person: '別の人を追加', remove_word: '削除', same_time_note: '全員が上で選んだ同じ日時で予約されます。各自がサービスとセラピストを選べます。', guest: 'ゲスト', group_booked: 'グループ予約 · {n}名', group_total: '合計（{n}名）',
